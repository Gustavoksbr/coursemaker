...
/**
 * Requests and responses for modules, lessons and content blocks (both lesson
 * and post).
 */
public final class CurriculumDtos {
        ...
        public record LessonResponse(
                ...
                public static LessonResponse of(Lesson lesson, boolean completed, List<BlockResponse> blocks) {
                        return new LessonResponse(
                                        lesson.getId(),
                                        lesson.getModule().getId(),
                                        lesson.getTitle(),
        ...
        // Content columns are unbounded TEXT in the database; this is a policy cap
        // against abuse, not
        // a storage constraint. Generous enough for a long article or a sizeable source
        // file.
